            ...
            if det is not None and len(det):
                ...
                for *xyxy, conf, cls in det:
                    ...
                    if save_img or view_img:  # Add bbox to image
                        ...
                        plot_one_box(xyxy, im0, label=label, color=colors[int(cls)]) # 参数xyxy中包含着bbox的坐标
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/yolov3-spp-80cls.cfg', help='*.cfg path')
